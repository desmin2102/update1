...
private TextView chinhSach;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String value="Điều 1: Mục đích\n" +
                ...
                "Điểm tích luỹ nghĩa là điểm được cấp cho thành viên theo tỷ lệ tích luỹ do HGB Cinema thông báo khi thành viên mua các sản phẩm hoặc dịch vụ từ HGB\n" +
                "Cinema.\n" +
                "Điểm sử dụng là điểm khách hàng đã sử dụng khi mua các sản phẩm dịch vụ hoặc đổi lấy quà tặng miễn phí tại HGB Cinema\n" +
                "Điểm hiện hữu nghĩa là điểm tích luỹ mà đáp ứng các tiêu chuẩn do công ty đặt ra, sau khi đã trừ những điểm mà thành viên đã sử dụng, và có sẵn để cho các thành viên sử dụng khi mua các sản phẩm dịch vụ từ\n" +
                "HGB Cinema hoặc đổi lấy quà tặng miễn phí, v.v..\n"+ "Điều 3: Chương Trình.\n" +
                "LOTTE Cinema cung cấp cho các thành viên một hoặc nhiều hình thức chương trình sau:\n" +
                "Tích luỹ và sử dụng điểm: Thành viên có thể sử dụng điểm được tích luỹ thông qua việc mua các sản phẩm và dịch vụ từ HGB Cinema theo quy định mà HGB\n" +
                "Cinema đặt ra.\n" +
                ...
                "Không thành viên nào được xin phép chuyển nhượng hay cho mượn tư cách thành viên của họ cho người\n" +
                "thứ ba và cũng không được sử dụng để làm vật bảo đảm.";
