...
public class MovieSessionBookingAdapter extends RecyclerView.Adapter<MovieSessionBookingAdapter.MovieSessionViewHolder> {

    private List<MovieSession> movieSessions;
    private Map<String, Room> roomMap;
    private Context context;

    public MovieSessionBookingAdapter(List<MovieSession> movieSessions, Map<String, Room> roomMap, Context context) {
    ...
    public MovieSessionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.booking_session_item, parent, false);
